...
class TestOpenRouterProvider:
    ...
    def test_model_alias_resolution(self):
        ...
        assert provider._resolve_model_name("mistral") == "mistralai/mistral-large-3"
...
class TestOpenRouterRegistry:
    ...
    def test_multiple_aliases_same_model(self):
        ...
        # "sonnet" now points to 4.6, "sonnet4.5" still points to 4.5
...
class TestOpenRouterFunctionality:
    ...
    def test_openrouter_headers_set_correctly(self):
        ...
        assert provider.DEFAULT_HEADERS["X-Title"] == "Panel MCP Server"
