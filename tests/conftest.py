"""
Pytest configuration for Panel MCP Server tests
"""
...
env_config.reload_env({"PANEL_MCP_FORCE_ENV_OVERRIDE": "false"})
...
def disable_force_env_override(monkeypatch):
    ...
    monkeypatch.setenv("PANEL_MCP_FORCE_ENV_OVERRIDE", "false")
    env_config.reload_env({"PANEL_MCP_FORCE_ENV_OVERRIDE": "false"})
