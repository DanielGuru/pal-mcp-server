...
class TestDockerVolumePersistence:
    ...
    def test_docker_compose_volumes_configuration(self):
        ...
        assert "panel-mcp-config:" in content, "panel-mcp-config volume must be defined"
        ...
        assert "panel-mcp-config:/app/conf" in content, "Config volume mount required"
    ...
    def test_volume_backup_restore_capability(self):
        ...
        assert "panel-mcp-config:/data" in backup_cmd
...
class TestDockerVolumeIntegration:
    ...
    def test_docker_compose_run_volume_usage(self):
        ...
        compose_run_cmd = ["docker-compose", "run", "--rm", "panel-mcp"]
