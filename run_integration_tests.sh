...
# Panel MCP Server - Run Integration Tests
...
echo "🧪 Running Integration Tests for Panel MCP Server"
echo "=============================================="
echo "These tests use real API calls with your configured keys"
echo ""

# Activate virtual environment
if [[ -f ".panel_venv/bin/activate" ]]; then
    source .panel_venv/bin/activate
