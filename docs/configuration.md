...
This guide covers all configuration options for the Panel MCP Server. The server is configured through environment variables defined in your `.env` file.
...
2. GPT-5.2-Pro generates structured implementation and shares the complete implementation with Panel
