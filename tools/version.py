"""
Version Tool - Display Panel MCP Server version and system information

This tool provides version information about the Panel MCP Server including
...
def fetch_github_version() -> Optional[tuple[str, str]]:
    ...
    github_url = "https://raw.githubusercontent.com/BeehiveInnovations/panel-mcp-server/main/config.py"
...
class VersionTool(BaseTool):
    """
    Tool for displaying Panel MCP Server version and system information.
    ...
    async def execute(self, arguments: dict[str, Any]) -> list[TextContent]:
        """
        Display Panel MCP Server version and system information.
        ...
        """
        output_lines = ["# Panel MCP Server Version\n"]
