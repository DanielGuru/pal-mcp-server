...
async def main():
    ...
    panel_routing = (
        ...
        "Always wrap any panel-family tool in start_task — they can run for "
        "several minutes per round. For free OAuth runs use codex+gemini+claude "
        "panelists with codex as judge — three frontier families at zero cost. "
        "Add grok-4.3 only when the user asks for paid model diversity or "
        "names it explicitly. "
